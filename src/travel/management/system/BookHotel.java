...
public class BookHotel extends JFrame implements ActionListener{
    ...
    BookHotel(String username){
        ...
        add(labelprice);
         ...
         try{
            Conn  conn = new Conn();
            String query = "select * from detailsofCustom where username = '"+username+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == checkprice){
            ...
            try{
                Conn c = new Conn();
                c.s.executeUpdate("insert into bookhotels values('"+labelusername.getText()+"', '"+chotel.getSelectedItem()+"','"+tfpersons.getText()+"', '"+tfdays.getText()+"', '"+cac.getSelectedItem()+"', '"+cfood.getSelectedItem()+"','"+labelid.getText()+"','"+labelnumber.getText()+"', '"+labelphonenumber.getText()+"','"+labelprice.getText()+"')");
