...
public class BookPackage extends JFrame implements ActionListener{
    ...
    BookPackage(String username){
        ...
        cpackage = new Choice();
        cpackage.add("Adventure Awaits");
        cpackage.add("Wildlife Wonders");
        cpackage.add("Hidden Gems");
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == checkprice){
           ...
           int cost = 0;
           if (pack.equals("Adventure Awaits")) {
               cost += 12000;
            } else if (pack.equals("Wildlife Wonders")) {
                cost += 18000;
            } else {
                cost += 16000;   
            }
