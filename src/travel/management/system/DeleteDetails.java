...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    DeleteDetails(String username){
        ...
        lblemailid.setBounds(500, 230, 150, 25);
        add(lblemailid);
        
        JLabel labelemailid = new JLabel();
        labelemailid.setBounds(690, 230, 150, 25);
        add(labelemailid);
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            c.s.executeUpdate("delete from detailsofCustom where username = '"+username+"'");
