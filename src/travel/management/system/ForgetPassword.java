...
public class ForgetPassword extends JFrame implements ActionListener{
    ...
    ForgetPassword(){
        ...
        retreive = new JButton("Retreive");
        retreive.setBackground(Color.GRAY);
        retreive.setForeground(Color.WHITE);
        retreive.setBounds(380, 140, 100, 25);
        retreive.addActionListener(this);
        p1.add(retreive);
        
        JLabel lblpassword = new JLabel("Passord");
