...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    JComboBox comboid;
    JTextField tfnumber, tfcountry, tfaddress, tfemailid, tfphonenumber;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn c = new Conn();
                String query = "insert into detailsofCustom values('"+username+"', '"+id+"', '"+number+"', '"+name+"', '"+gender+"', '"+country+"', '"+address+"', '"+phonenumber+"', '"+emailid+"')";
